...
<li @if($slug == 'rfc')class="active"@endif><a href="{{ url('/bookings/rfc') }}"><span class="fa-stack">
    <span class="fa fa-circle-o fa-stack-2x"></span><strong class="fa-stack-1x">
        1    
    </strong>
</span></span> Ready For Contracts <span class="badge badge-light">{{ $form_2 }}</span></a></li>      
